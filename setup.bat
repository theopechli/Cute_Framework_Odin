...
if not exist "%LIBS_CUTE_FRAMEWORK_PATH%\lib" mkdir "%LIBS_CUTE_FRAMEWORK_PATH%\lib"
...
for /r "%CUTE_FRAMEWORK_PATH%\%CUTE_FRAMEWORK_BUILD_DIR%" %%F in (*.lib) do copy "%%F" "%LIBS_CUTE_FRAMEWORK_PATH%\lib\"
