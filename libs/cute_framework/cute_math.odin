...
foreign lib {
	...
	circle_to_poly_manifold     :: proc(A: Circle, B: ^Poly) -> Manifold ---
	aabb_to_poly_manifold       :: proc(A: Aabb, B: ^Poly) -> Manifold ---
	poly_to_poly_manifold       :: proc(A: ^Poly, B: ^Poly) -> Manifold ---
}
...
@(link_prefix = "cf_", default_calling_convention = "c")
foreign lib {
	toi     :: proc(A: rawptr, typeA: ShapeType, vA: V2, B: rawptr, typeB: ShapeType, vB: V2, use_radius: c.int) -> ToiResult ---
	collide :: proc(A: rawptr, typeA: ShapeType, B: rawptr, typeB: ShapeType, m: ^Manifold) ---
}
